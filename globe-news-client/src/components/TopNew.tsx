  ...
  return (
    <div className="flex justify-center items-center h-screen mt-36">
      <div className="grid grid-cols-2 grid-rows-2 gap-4 ">
        <a href="" className="relative w-[502px] h-[502px] hover:text-red-700 text-white">
          <img
            src={PoliticaImg}
            alt=""
          ...
          <h1 className="absolute inset-0 flex flex-col justify-end  text-2xl font-extrabold p-4">
        ...
        <a href="" className="relative w-[502px] h-[502px] hover:text-red-700 text-white">
          ...
          <span className="absolute inset-0 bg-black bg-opacity-20"></span>
          <h1 className="absolute inset-0 flex flex-col justify-end  text-2xl font-extrabold p-4">
            Imagem completamente aleátória jutanmente com simulação de notícia!
          </h1>
        </a>
      </div>
    </div>
